...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        score, high = previous_score, previous_high
        if who == 0:
            if score0 - score > high:
                high = score0 - score
                print(high, "point(s)! That's the biggest gain yet for Player", who)
            score = score0
        else:
            if score1 - score > high:
                high = score1 - score
                print(high, "point(s)! That's the biggest gain yet for Player", who)
            score = score1
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if (opponent_score > score and is_swap(score, opponent_score)) or (free_bacon(opponent_score) >= margin and is_swap(score, opponent_score) == False):
        return 0
    else:
        return num_rolls
